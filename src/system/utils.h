...
/*
    Custom BEGIN and END Namespace preprocessor directives. 
    ...
    To help you find the source, you should activate the display of file inclusion in advanced C++ settings
    of the project.
*/

enum
{
    InElixirNamespace = false
};
...
{ 
    enum 
    { 
        InElixirNamespace = true 
    }; 
}

#define exrBEGIN_NAMESPACE  \
    exrStaticAssertMsg(!InElixirNamespace, "elixir namespace not previously closed");\
    namespace elixir {

#define exrEND_NAMESPACE    \
    } exrStaticAssertMsg(!InElixirNamespace, "elixir namespace not previously closed");
