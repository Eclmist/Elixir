...
public:
    ...
    void AddFloat                   (const exrString& key, const exrFloat*,   exrU32 numVal);
    ...
    exrBool RemoveFloat             (const exrString& key);
...
private:
    ...
    std::vector<std::unique_ptr<ParamSetItem<exrFloat>>>    m_Floats;
